...
<template>
  ...
  <button @click="edit" class="py-2.5 px-5 me-2 mb-2 text-sm font-medium 
  ...
  dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Edit</button>
</template>
